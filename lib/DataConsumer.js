...
class DataConsumer extends EnhancedEventEmitter_1.EnhancedEventEmitter {
    ...
    close() {
        ...
        this._payloadChannel.off(this._internal.dataConsumerId, this._payloadChannelListener);
    ...
    _handleWorkerNotifications() {
        ...
        this._payloadChannel.on(this._internal.dataConsumerId, this._payloadChannelListener);
    }
    _onPayloadChannelEvent(event, data, payload) {
        switch (event) {
            case 'message':
                {
                    if (this._closed)
