...
class Consumer extends EnhancedEventEmitter_1.EnhancedEventEmitter {
    ...
    close() {
        ...
        this._payloadChannel.off(this._internal.consumerId, this._payloadChannelListener);
    ...
    _handleWorkerNotifications() {
        ...
        this._payloadChannel.on(this._internal.consumerId, this._payloadChannelListener);
    }
